...
{   
    app.get('/inv/libera-mista/va18', (req, res) =>{
    ...
    app.get('/inv/libera-mista/va19', (req, res) =>{
        const calendar_rows = fs.readFileSync('cache/table-'+calendari_inv.va19[1]+'-CALENDAR.html');
        const rank_rows = fs.readFileSync('cache/table-'+calendari_inv.va19[1]+'-RANKING.html');
    ...
    app.get('/inv/libera-mista/va20', (req, res) =>{
